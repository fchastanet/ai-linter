...
class TestUnreferencedFileValidator(unittest.TestCase):
    ...
    def test_no_directories(self) -> None:
        ...
        warnings, errors = self.validator.validate_unreferenced_files(
            self.test_dir, skill_md, skill_md.read_text()
        )
...
"""
        ...
        warnings, errors = self.validator.validate_unreferenced_files(
            self.test_dir, skill_md, content
        )
...
"""
    ...
    def test_normalize_path(self) -> None:
        ...
        # Test multiple ../
        self.assertEqual(
            self.validator._normalize_path("dir1/dir2/../../assets/file.txt"),
            "assets/file.txt"
        )
